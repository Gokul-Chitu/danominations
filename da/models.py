...
class nomination(models.Model):
    ...
    secondyear = 2
    thirdyear = 3
    POS_CHOICES = (('President', 'President/Vice President (Batch 2014-18)'), ('Tresurer', 'Tresurer (Batch 2014-18)'),('Secretary', 'Secretary (Batch 2015-19)'),('Joint Secretary', 'Join Secretary (Batch 2016-20)'))

    rollno = models.CharField(max_length=10,null=True)
    name = models.CharField(max_length=255)
    gender = models.IntegerField(choices=GENDER_CHOICES)
    YEAR_CHOICES = ((firstyear, 'I (Batch 2016-20)'), (secondyear, 'II (Batch 2015-19)'),(thirdyear, 'III (Batch 2014-18)'))
    year = models.IntegerField(choices=YEAR_CHOICES,default=firstyear)
    BRANCH_CHOICES = (('Aeronautical Engineering','Aeronautical Engineering'),('Automobile Engineering','Automobile Engineering'),('Bio-Technology','Bio-Technology'),('Civil Engineering','Civil Engineering'),('Computer Applications','Computer Applications'),('Computer Science and Engineering','Computer Science and Engineering')
    ...
    cgpa = models.FloatField(max_length=255)
